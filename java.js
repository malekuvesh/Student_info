function update(cardId) {
    // document.getElementById("younic").innerText = document.getElementById("ueszo").value;
    document.getElementById("uveshes").innerText = document.getElementById("seates").value;
    document.getElementById("younic").innerText = document.getElementById("ueszo").value;
    // document.getElementById("scholes").innerText = document.getElementById("filedes").value;
